...
# 注意：业务流程编排方法已迁移到 services.ai_analysis
# - analyze_external_assets() -> services.ai_analysis.analyze_external_assets()
# - analyze_market_overview() -> services.ai_analysis.analyze_market_overview()
# - analyze_index_technical() -> services.ai_analysis.analyze_index_technical()
# - analyze_stock_classification() -> services.ai_analysis.analyze_stock_classification()

# 保留原子能力供 services 层调用：
# - build_macro_prompt()
